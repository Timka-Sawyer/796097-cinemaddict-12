...
const createMainNavigationTemplate = () => {
  return (
    ...
    <div class="main-navigation__items"><a href="#all" class="main-navigation__item main-navigation__item--active">All movies</a>
...
const mainSortElement = siteMainElement.querySelector(`.sort`);
